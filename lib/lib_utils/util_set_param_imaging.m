...
switch param_general.algorithm
    case 'airi'
        subFolderName = [param_general.srcName, '-AIRI_heuScale_', ...
            num2str(param_algo.heuNoiseScale), ...
            '_maxItr_', num2str(param_algo.imMaxItr)];
    case 'cairi'
        subFolderName = [param_general.srcName, '-cAIRI_heuScale_', ...
            num2str(param_algo.heuNoiseScale), ...
            '_maxItr_', num2str(param_algo.imMaxItr)];
    case 'upnp-bm3d'
        subFolderName = [param_general.srcName, '-uPnP-BM3D_heuScale_', ...
            num2str(param_algo.heuNoiseScale), ...
            '_maxItr_', num2str(param_algo.imMaxItr)];
    case 'cpnp-bm3d'
        subFolderName = [param_general.srcName, '-cPnP-BM3D_heuScale_', ...
            num2str(param_algo.heuNoiseScale), ...
            '_maxItr_', num2str(param_algo.imMaxItr)];
end
% set full path
